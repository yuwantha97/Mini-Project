...
const Actions = styled.div`
  ...
  .primaryAction {
    ${tw`bg-teal-900 text-gray-100 hover:bg-teal-700`}
  }
  .secondaryAction {
...
export default    ({
  ...
  heading = (
    <>
      Get A Better Learning
      <wbr />
      <br />
      <span tw="text-teal-700">From Your Own</span>
    </>
  ),
  description = "Stay with us.All the new learning platform are connect with us all new learning abilities",
